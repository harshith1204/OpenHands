...
# Current-generation xAI models for self-hosted verified discovery.
# Legacy Grok slugs are intentionally excluded.
XAI_VERIFIED_MODELS: list[str] = ['grok-4.3', 'grok-build-0.1']
XAI_MODELS: list[str] = [f'xai/{m}' for m in XAI_VERIFIED_MODELS]
...
DEFAULT_OPENHANDS_MODEL = get_default_llm_model()
